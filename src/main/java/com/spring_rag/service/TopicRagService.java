...
public class TopicRagService {
     ...
     */
    public QueryResponse queryTopic(String topic, QueryRequest request) {
        // Validate topic
        ...
        try {
            ...
            log.error("RAG query failed for topic: {}", topic, ex);
            throw new RuntimeException("RAG query failed for topic " + topic + ": " + ex.getMessage());
        }
    }
     ...
     */
    public QueryResponse queryCrossTopic(List<String> topics, QueryRequest request) {
        try {
            ...
            throw new RuntimeException("Cross-topic query failed: " + ex.getMessage());
        }
    }
}